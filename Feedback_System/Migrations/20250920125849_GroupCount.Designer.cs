...
namespace Feedback_System.Migrations
{
    ...
    [Migration("20250920125849_GroupCount")]
    partial class GroupCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Feedback_System.Model.FeedbackGroup", b =>
                {
                    b.Property<int>("FeedbackGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FeedbackGroupId"));
            ...
            modelBuilder.Entity("Feedback_System.Model.FeedbackSubmit", b =>
                {
                    ...
                    b.Property<int?>("feedback_group_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Feedback_System.Model.RoleAccess", b =>
                {
                    ...
                    b.Property<int>("Studentsstudent_rollno")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Studentsstudent_rollno");
            ...
            modelBuilder.Entity("Feedback_System.Model.FeedbackSubmit", b =>
                {
                    b.HasOne("Feedback_System.Model.FeedbackGroup", "FeedbackGroup")
                        .WithMany()
                        .HasForeignKey("feedback_group_id");
            ...
            modelBuilder.Entity("Feedback_System.Model.RoleAccess", b =>
                {
                    b.HasOne("Feedback_System.Model.Student", "Students")
                        .WithMany()
                        .HasForeignKey("Studentsstudent_rollno")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
